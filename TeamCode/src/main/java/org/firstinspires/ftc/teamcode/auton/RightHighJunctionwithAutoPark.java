...
@Config
@Autonomous(name = "Right High-Junction with AutoPark")
public class RightHighJunctionwithAutoPark extends LinearOpMode {
...
//        lift.setDirection(DcMotorSimple.Direction.REVERSE);
        ...
        TrajectorySequence Coning = drive.trajectorySequenceBuilder(StartPose)
                ...
                .addTemporalMarker(() -> {
                    robot.lift(robot.ARMUP3);
                })
                .waitSeconds(4)
                .addTemporalMarker(() -> {
                    robot.turret(robot.TurretleftHigh);
                })
                .waitSeconds(3)
                .addTemporalMarker(() -> {
